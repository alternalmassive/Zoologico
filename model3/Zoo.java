...
public class Zoo
{
	...
	{
		String report;
		report = "Reporte del ambiente 1: " + getEnvironment1().showReportKangaroo() + "\n";
		report = report + "\nReporte del ambiente 2: " + getEnvironment2().showReportKangaroo() + "\n";
		report = report + "\nReporte del ambiente 3: " + getEnvironment3().showReportKangaroo() + "\n";
		report = report + "\nReporte del ambiente 4: " + getEnvironment4().showReportDragon() + "\n";
		return report;
	}
}